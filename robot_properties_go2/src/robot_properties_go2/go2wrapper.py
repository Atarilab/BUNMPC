...
class Go2Robot(PinBulletWrapper):
    def __init__(
        ...
        * [
        ...
        pybullet.setAdditionalSearchPath(Go2Config.resources.package_path)
        ...
        self.hl_index = self.pin_robot.model.getFrameId("RL_foot_joint")
        self.hr_index = self.pin_robot.model.getFrameId("RR_foot_joint")
        self.fl_index = self.pin_robot.model.getFrameId("FL_foot_joint")
        self.fr_index = self.pin_robot.model.getFrameId("FR_foot_joint")
    ...
    def reset_to_initial_state(self) -> None:
        """Reset robot state to the initial configuration (based on Go2Config)."""
...
class Go2RobotWithoutPybullet():
    ...
    def reset_to_initial_state(self) -> None:
        """Reset robot state to the initial configuration (based on Go2Config)."""
        q0 = np.array(Go2Config.initial_configuration)
        dq0 = np.array(Go2Config.initial_velocity)
        self.reset_state(q0, dq0)
