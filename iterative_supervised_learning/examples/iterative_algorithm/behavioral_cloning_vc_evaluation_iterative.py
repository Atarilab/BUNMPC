...
project_name = 'bc_single_gait_multi_goal_with_stop'
...
class BehavioralCloning():  
    ...
    def run(self):   
        ...
        network_dir = '/home/atari_ws/data/behavior_cloning/trot/bc_single_gait_multi_goal_with_stop/network'
        raw_files = os.listdir(network_dir)
        ...
        for file in files:
            ...
            training_iter = int(file[3:-4])
            
            print('=== Evaluating Network from Training Iteration ' + str(training_iter) + ' ===')
                ...
                for gait in self.gaits:
                    ...
                    for i_replan in range(num_replanning):
                        ...
                        for i_pertubation in range(self.num_pertubations_per_replanning_eval):
                            ...
                            wandb.init(project=project_name, config={'iteration': training_iter, 'gait':gait, 'vx_des':v_des[0]}, name=str(i_main)+'_'+str(i_replan)+'_'+str(i_pertubation))                        
