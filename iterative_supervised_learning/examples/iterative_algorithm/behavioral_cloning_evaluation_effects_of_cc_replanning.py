...
project_name = 'bc_single_gait_multi_goal_effects_of_replanning'
...
class BehavioralCloning():  
    ...
    def create_desired_contact_schedule(self, pin_robot, urdf_path, q0, v0, v_des, w_des, gait, start_time):
        ...
        Args:
            ...
            gait (str): gait to simulate.
            start_time (float): starting time which is effect the gait phase
    ...
    def run(self):   
        ...
        self.load_network(filename='/home/atari_ws/data/behavior_cloning/trot/bc_single_gait_multi_goal_with_stop/network/cc_150.pth', goal_type='cc')
        self.load_network(filename='/home/atari_ws/data/behavior_cloning/trot/bc_single_gait_multi_goal_with_stop/network/vc_150.pth', goal_type='vc')
            ...
            for gait in self.gaits:
                ...
                for i_replan in range(num_replanning):
                    ...
                    for i_pertubation in range(self.num_pertubations_per_replanning_eval):
                        ...
                        for gt in ['cc_replan', 'cc_no_replan', 'vc']:
                            print('=== ' + gt + ' ===')
                            
                            wandb.init(project=project_name, config={'goal_type':gt, 'gait':gait}, name=gt+'_'+str(i_main)+'_'+str(i_replan)+'_'+str(i_pertubation))                        
                            ...
                            elif (gt == 'cc_replan') or (gt == 'cc_no_replan'):
